        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route('admin.users.examinations.storeForUser',$user->id) }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="exam_date" id="exam_date" class="form-control form-control-sm @error('exam_date') is-invalid @enderror"
                                               value="{{ old('exam_date', \Carbon\Carbon::now()->format('Y-m-d')) }}"
                                               required>
                                        @error('exam_date')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="exam_type" id="exam_type" class="form-control form-control-sm @error('exam_type') is-invalid @enderror" required>
                                            <option value="consultation" {{ old('exam_type') == 'consultation' ? 'selected' : '' }}>Consultation</option>
                                            <option value="consultation_with_glasses" {{ old('exam_type') == 'consultation_with_glasses' ? 'selected' : '' }}>Consultation with Glasses</option>
                                        </select>
                                        @error('exam_type')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                @foreach(['sph_od', 'cyl_od', 'axis_od', 'add_od', 'prism_od', 'sci_od'] as $field)
                                    <div class="col-md-2 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="{{ $field }}" id="{{ $field }}" class="form-control form-control-sm" value="{{ old($field) }}">
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @endforeach
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ipd" id="ipd" class="form-control form-control-sm @error('ipd') is-invalid @enderror" value="{{ old('ipd') }}">
                                                @error('ipd')
                                                <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="notes" id="notes" rows="2" class="form-control form-control-sm @error('notes') is-invalid @enderror">{{ old('notes') }}</textarea>
                                                @error('notes')
                                                <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
    ...
    <script>
        function togglePrescriptionFields() {
            ...
            if (examType === 'consultation_with_glasses') {
                ...
                calculateTotal(); // Start total calculation immediately
            } else {
