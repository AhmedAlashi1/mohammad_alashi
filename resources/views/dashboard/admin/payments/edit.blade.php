        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.examinations.payments.update', ['examination' => $payment->examination_id, 'payment' => $payment->id]) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_type" id="payment_type"
                                                ...
                                                required>
                                            <option value="consultation" {{ old('payment_type', $payment->payment_type) == 'consultation' ? 'selected' : '' }}>Consultation</option>
                                            <option value="glasses" {{ old('payment_type', $payment->payment_type) == 'glasses' ? 'selected' : '' }}>Glasses</option>
                                        </select>
                                        @error('payment_type')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
